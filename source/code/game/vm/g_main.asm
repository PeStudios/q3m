...
LABELV $826
line 1504
;1503:		// ATVI Q3 1.32 Patch #9, WNF
;1504:		if ( level.voteYes > level.numVotingClients/2 ) {
ADDRGP4 level+2412
INDIRI4
ADDRGP4 level+2420
INDIRI4
...
LEI4 $831
line 1506
;1505:			// execute the command, then remove the vote
;1506:			trap_SendServerCommand( -1, "print \"Vote passed.\n\"" );
CNSTI4 -1
ARGI4
ADDRGP4 $835
ARGP4
...
pop
line 1507
;1507:			level.voteExecuteTime = level.time + 3000;
ADDRGP4 level+2408
ADDRGP4 level+32
INDIRI4
CNSTI4 3000
...
ASGNI4
line 1508
;1508:		} else if ( level.voteNo >= level.numVotingClients/2 ) {
ADDRGP4 $832
JUMPV
LABELV $831
ADDRGP4 level+2416
...
LTI4 $814
line 1510
;1509:			// same behavior as a timeout
;1510:			trap_SendServerCommand( -1, "print \"Vote failed.\n\"" );
CNSTI4 -1
ARGI4
ADDRGP4 $830
ARGP4
...
;1511:		} else {
line 1513
;1512:			// still waiting for a majority
;1513:			return;
LABELV $839
LABELV $832
line 1515
...
LABELV $827
line 1516
;1516:	level.voteTime = 0;
ADDRGP4 level+2404
CNSTI4 0
ASGNI4
line 1517
;1517:	trap_SetConfigstring( CS_VOTE_TIME, "" );
CNSTI4 8
ARGI4
ADDRGP4 $54
ARGP4
...
;1524:==================
;1525:*/
;1526:void PrintTeam(int team, char *message) {
line 1529
;1527:	int i;
;1528:
;1529:	for ( i = 0 ; i < level.maxclients ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $847
...
LABELV $849
line 1532
;1532:		trap_SendServerCommand( i, message );
ADDRLP4 0
INDIRI4
ARGI4
ADDRFP4 4
...
;1539:==================
;1540:*/
;1541:void SetLeader(int team, int client) {
line 1544
;1542:	int i;
;1543:
;1544:	if ( level.clients[client].pers.connected == CON_DISCONNECTED ) {
CNSTI4 776
ADDRFP4 4
INDIRI4
MULI4
...
NEI4 $852
line 1545
;1545:		PrintTeam(team, va("print \"%s is not connected\n\"", level.clients[client].pers.netname) );
ADDRGP4 $854
ARGP4
CNSTI4 776
ADDRFP4 4
...
line 1548
;1547:	}
;1548:	if (level.clients[client].sess.sessionTeam != team) {
CNSTI4 776
ADDRFP4 4
INDIRI4
MULI4
...
EQI4 $855
line 1549
;1549:		PrintTeam(team, va("print \"%s is not on the team anymore\n\"", level.clients[client].pers.netname) );
ADDRGP4 $857
ARGP4
CNSTI4 776
ADDRFP4 4
...
line 1552
;1551:	}
;1552:	for ( i = 0 ; i < level.maxclients ; i++ ) {
ADDRLP4 0
CNSTI4 0
ASGNI4
ADDRGP4 $861
...
LABELV $858
line 1553
;1553:		if (level.clients[i].sess.sessionTeam != team)
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
LABELV $863
line 1555
;1555:		if (level.clients[i].sess.teamLeader) {
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
EQI4 $865
line 1556
;1556:			level.clients[i].sess.teamLeader = qfalse;
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
LTI4 $858
line 1560
;1560:	level.clients[client].sess.teamLeader = qtrue;
CNSTI4 776
ADDRFP4 4
INDIRI4
MULI4
...
ASGNI4
line 1561
;1561:	ClientUserinfoChanged( client );
ADDRFP4 4
INDIRI4
ARGI4
ADDRGP4 ClientUserinfoChanged
...
pop
line 1562
;1562:	PrintTeam(team, va("print \"%s is the new team leader\n\"", level.clients[client].pers.netname) );
ADDRGP4 $867
ARGP4
CNSTI4 776
ADDRFP4 4
...
;1565:/*
;1566:==================
;1567:CheckTeamLeader
;1568:==================
;1569:*/
;1570:void CheckTeamLeader( int team ) {
line 1573
;1571:	int i;
;1572:
...
LABELV $881
line 1581
;1581:			if (level.clients[i].sess.sessionTeam != team)
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
LABELV $886
line 1583
;1583:			if (!(g_entities[i].r.svFlags & SVF_BOT)) {
CNSTI4 808
ADDRLP4 0
INDIRI4
MULI4
...
NEI4 $888
line 1584
;1584:				level.clients[i].sess.teamLeader = qtrue;
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
LABELV $897
line 1591
;1591:			level.clients[i].sess.teamLeader = qtrue;
CNSTI4 776
ADDRLP4 0
INDIRI4
MULI4
...
;1600:==================
;1601:*/
;1602:void CheckTeamVote( int team ) {
line 1605
;1603:	int cs_offset;
;1604:
;1605:	if ( team == TEAM_RED )
ADDRFP4 0
INDIRI4
CNSTI4 1
NEI4 $900
...
line 1612
;1611:
;1612:	if ( !level.teamVoteTime[cs_offset] ) {
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
line 1615
;1614:	}
;1615:	if ( level.time - level.teamVoteTime[cs_offset] >= VOTE_TIME ) {
ADDRGP4 level+32
INDIRI4
ADDRLP4 0
INDIRI4
...
LTI4 $907
line 1616
;1616:		trap_SendServerCommand( -1, "print \"Team vote failed.\n\"" );
CNSTI4 -1
ARGI4
ADDRGP4 $911
ARGP4
...
LABELV $907
line 1618
;1618:		if ( level.teamVoteYes[cs_offset] > level.numteamVotingClients[cs_offset]/2 ) {
ADDRLP4 4
CNSTI4 2
ASGNI4
ADDRLP4 8
...
LEI4 $912
line 1620
;1619:			// execute the command, then remove the vote
;1620:			trap_SendServerCommand( -1, "print \"Team vote passed.\n\"" );
CNSTI4 -1
ARGI4
ADDRGP4 $916
ARGP4
...
line 1622
;1621:			//
;1622:			if ( !Q_strncmp( "leader", level.teamVoteString[cs_offset], 6) ) {
ADDRGP4 $919
ARGP4
ADDRLP4 0
INDIRI4
...
NEI4 $917
line 1624
;1623:				//set the team leader
;1624:				SetLeader(team, atoi(level.teamVoteString[cs_offset] + 7));
ADDRLP4 0
INDIRI4
CNSTI4 10
LSHI4
...
;1626:			else {
line 1627
;1627:				trap_SendConsoleCommand( EXEC_APPEND, va("%s\n", level.teamVoteString[cs_offset] ) );
ADDRGP4 $821
ARGP4
ADDRLP4 0
INDIRI4
...
;1628:			}
line 1629
;1629:		} else if ( level.teamVoteNo[cs_offset] >= level.numteamVotingClients[cs_offset]/2 ) {
ADDRGP4 $913
JUMPV
LABELV $912
ADDRLP4 12
...
LTI4 $899
line 1631
;1630:			// same behavior as a timeout
;1631:			trap_SendServerCommand( -1, "print \"Team vote failed.\n\"" );
CNSTI4 -1
ARGI4
ADDRGP4 $911
ARGP4
...
;1632:		} else {
line 1634
;1633:			// still waiting for a majority
;1634:			return;
LABELV $925
LABELV $913
line 1636
...
LABELV $908
line 1637
;1637:	level.teamVoteTime[cs_offset] = 0;
ADDRLP4 0
INDIRI4
CNSTI4 2
LSHI4
...
ASGNI4
line 1638
;1638:	trap_SetConfigstring( CS_TEAMVOTE_TIME + cs_offset, "" );
ADDRLP4 0
INDIRI4
CNSTI4 12
ADDI4
...
;1646:==================
;1647:*/
;1648:void CheckCvars( void ) {
line 1651
;1649:	static int lastMod = -1;
;1650:
;1651:	if ( g_password.modificationCount != lastMod ) {
...
EQI4 $931
line 1652
;1652:		lastMod = g_password.modificationCount;
ADDRGP4 $930
ADDRGP4 g_password+4
INDIRI4
ASGNI4
line 1653
;1653:		if ( *g_password.string && Q_stricmp( g_password.string, "none" ) ) {
...
EQI4 $935
line 1654
;1654:			trap_Cvar_Set( "g_needpass", "1" );
ADDRGP4 $84
ARGP4
ADDRGP4 $83
ARGP4
...
LABELV $935
line 1656
;1656:			trap_Cvar_Set( "g_needpass", "0" );
ADDRGP4 $84
ARGP4
ADDRGP4 $60
ARGP4
...
;1663:G_RunThink
;1664:
;1665:Runs thinking code for this frame if necessary
;1666:=============
;1667:*/
;1668:void G_RunThink (gentity_t *ent) {
line 1671
;1669:	float	thinktime;
;1670:
;1671:	thinktime = ent->nextthink;
ADDRLP4 0
ADDRFP4 0
INDIRP4
CNSTI4 688
...
;1688:G_RunFrame
;1689:
;1690:Advances the non-player objects in the world
;1691:================
;1692:*/
;1693:void G_RunFrame( int levelTime ) {
line 1700
;1694:	int			i;
;1695:	gentity_t	*ent;
;1696:	int			msec;
;1697:int start, end;
;1698:
;1699:	// if we are waiting for the level to restart, do nothing
;1700:	if ( level.restarted ) {
ADDRGP4 level+68
INDIRI4
CNSTI4 0
EQI4 $950
...
ASGNI4
line 1705
;1705:	level.previousTime = level.time;
ADDRGP4 level+36
ADDRGP4 level+32
INDIRI4
ASGNI4
line 1706
;1706:	level.time = levelTime;
ADDRGP4 level+32
ADDRFP4 0
INDIRI4
ASGNI4
line 1707
;1707:	msec = level.time - level.previousTime;
ADDRLP4 16
ADDRGP4 level+32
INDIRI4
ADDRGP4 level+36
...
;1711:
;1712:	//
;1713:	// go through all allocated objects
;1714:	//
;1715:	start = trap_Milliseconds();
ADDRLP4 24
...
ASGNI4
line 1716
;1716:	ent = &g_entities[0];
ADDRLP4 0
ADDRGP4 g_entities
ASGNP4
line 1717
;1717:	for (i=0 ; i<level.num_entities ; i++, ent++) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRGP4 $962
...
;1720:		}
;1721:
;1722:		// clear events that are too old
;1723:		if ( level.time - ent->eventTime > EVENT_VALID_MSEC ) {
ADDRGP4 level+32
INDIRI4
ADDRLP4 0
INDIRP4
...
EQI4 $969
line 1725
;1725:				ent->s.event = 0;	// &= EV_EVENT_BITS;
ADDRLP4 0
INDIRP4
CNSTI4 180
ADDP4
...
EQU4 $971
line 1727
;1727:					ent->client->ps.externalEvent = 0;
ADDRLP4 0
INDIRP4
CNSTI4 516
ADDP4
...
ASGNI4
line 1731
;1728:					// predicted events should never be set to zero
;1729:					//ent->client->ps.events[0] = 0;
;1730:					//ent->client->ps.events[1] = 0;
;1731:				}
LABELV $971
line 1732
;1732:			}
...
EQI4 $973
line 1735
;1734:				// tempEntities or dropped items completely go away after their event
;1735:				G_FreeEntity( ent );
ADDRLP4 0
INDIRP4
ARGP4
...
LABELV $973
line 1737
;1737:			} else if ( ent->unlinkAfterEvent ) {
ADDRLP4 0
INDIRP4
CNSTI4 560
ADDP4
...
EQI4 $975
line 1739
;1738:				// items that will respawn will hide themselves after their pickup event
;1739:				ent->unlinkAfterEvent = qfalse;
ADDRLP4 0
INDIRP4
CNSTI4 560
ADDP4
...
line 1745
;1743:
;1744:		// temporary entities don't think
;1745:		if ( ent->freeAfterEvent ) {
ADDRLP4 0
INDIRP4
CNSTI4 556
ADDP4
...
;1747:		}
;1748:
;1749:		if ( !ent->r.linked && ent->neverFree ) {
ADDRLP4 32
CNSTI4 0
ASGNI4
ADDRLP4 0
...
;1751:		}
;1752:
;1753:		if ( ent->s.eType == ET_MISSILE ) {
ADDRLP4 0
INDIRP4
CNSTI4 4
ADDP4
...
;1756:		}
;1757:
;1758:		if ( ent->s.eType == ET_ITEM || ent->physicsObject ) {
ADDRLP4 0
INDIRP4
CNSTI4 4
ADDP4
...
;1766:		}
;1767:
;1768:		if ( i < MAX_CLIENTS ) {
ADDRLP4 4
INDIRI4
CNSTI4 64
GEI4 $988
line 1769
;1769:			G_RunClient( ent );
ADDRLP4 0
INDIRP4
ARGP4
ADDRGP4 G_RunClient
...
ASGNI4
line 1779
;1778:	// perform final fixups on the players
;1779:	ent = &g_entities[0];
ADDRLP4 0
ADDRGP4 g_entities
ASGNP4
line 1780
;1780:	for (i=0 ; i < level.maxclients ; i++, ent++ ) {
ADDRLP4 4
CNSTI4 0
ASGNI4
ADDRGP4 $993
...
line 1788
;1786:
;1787:	// see if it is time to do a tournement restart
...
line 1791
;1789:
;1790:	// see if it is time to end the level
;1791:	CheckExitRules();
ADDRGP4 CheckExitRules
CALLV
pop
line 1794
;1792:
;1793:	// update to team status?
;1794:	CheckTeamStatus();
ADDRGP4 CheckTeamStatus
CALLV
pop
line 1797
;1795:
;1796:	// cancel vote if timed out
;1797:	CheckVote();
ADDRGP4 CheckVote
CALLV
pop
line 1800
;1798:
;1799:	// check team votes
;1800:	CheckTeamVote( TEAM_RED );
CNSTI4 1
ARGI4
...
line 1806
;1805:
;1806:	if (g_listEntity.integer) {
ADDRGP4 g_listEntity+12
INDIRI4
CNSTI4 0
EQI4 $997
line 1807
;1807:		for (i = 0; i < MAX_GENTITIES; i++) {
ADDRLP4 4
CNSTI4 0
ASGNI4
LABELV $1000
...
LTI4 $1000
line 1810
;1810:		trap_Cvar_Set("g_listEntity", "0");
ADDRGP4 $110
ARGP4
ADDRGP4 $60
ARGP4
